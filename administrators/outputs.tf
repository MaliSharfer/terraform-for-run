...
output subnet_id_emails {
  value       = azurerm_subnet.vnet_subnet[var.virtual_networks_and_subnets_properties[1].snet_name].id
}

output subnet_id_subscription_automation {
  value       = azurerm_subnet.vnet_subnet[var.virtual_networks_and_subnets_properties[2].snet_name].id
}

output subnet_id_storages_automation {
  value       = azurerm_subnet.vnet_subnet[var.virtual_networks_and_subnets_properties[3].snet_name].id
}
